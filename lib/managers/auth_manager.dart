...
class AuthManager {
  ...
  void startListening() {
    ...
    _authListener = FirebaseAuth.instance
        .authStateChanges()
        .listen((User? user) {
          ...
          if(user == null) {
            ...
            print("User is signed out! Email: $email Uid: $uid");
          }
    });
  }
  ...
  Future<void> createNewUserEmailPassword({
    ...
    try{
      ...
      if(e.code == 'weak-password') {
        ...
        _showAuthSnackbar(context: context, authErrorMessage: "The account already exists for that email.");
      }
    } catch (e) {
  ...
  void _showAuthSnackbar({
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text(authErrorMessage))
    );
  }
